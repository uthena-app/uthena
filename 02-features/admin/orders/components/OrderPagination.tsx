// OrderPagination.tsx — URL-driven pager for /admin/orders.
...
function pageHref(
  ...
  if (filters.affiliateId !== null) params.set('affiliateId', String(filters.affiliateId))
  if (filters.productId !== null) params.set('productId', String(filters.productId))
  if (filters.partnerId !== null) params.set('partnerId', String(filters.partnerId))
...
export function OrderPagination({
  ...
  return (
    <nav className={styles.pager} aria-label="Order pagination">
      {page > 1 ? (
        <Link
