// /partner/onboarding/thanks/loading — RSC. Mirrors the thanks
// page shape so the user never sees unstyled content while the
// session + partner-row + draft reads resolve. Same pattern as
// P0.24's loading surfaces + the /partner/onboarding sibling route.

import styles from './loading.module.css'

export default function PartnerOnboardingThanksLoading() {
  return (
