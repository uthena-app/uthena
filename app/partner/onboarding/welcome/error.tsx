// /partner/onboarding/welcome/error — client component per Next.js
...
export default function PartnerOnboardingWelcomeError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && error.digest) {
      ...
      console.error('partner-onboarding/welcome route errored:', error.digest)
    }
  }, [error])
    ...
    <main className={styles.page} role="alert" aria-live="assertive">
      <div className={styles.card}>
        ...
        <p className={styles.lede}>
          Something went wrong on our side. Your saved progress is intact —
