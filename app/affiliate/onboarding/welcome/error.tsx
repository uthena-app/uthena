...
export default function AffiliateOnboardingWelcomeError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && error.digest) {
      ...
      console.error('affiliate-onboarding/welcome route errored:', error.digest)
    }
  }, [error])
  ...
  return (
    <main className={styles.page} role="alert" aria-live="assertive">
      <div className={styles.card}>
        <h1 className={styles.h1}>We couldn&apos;t load the welcome page.</h1>
        <p className={styles.lede}>
          Something went wrong on our side. You can pick up the
          onboarding wizard from where you left off — try again, or
        ...
        <div className={styles.actions}>
          ...
          <Link href="/affiliate/onboarding" className={styles.secondary}>
