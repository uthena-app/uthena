// /affiliate/onboarding/thanks/error — client component per Next.js
...
export default function AffiliateOnboardingThanksError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && error.digest) {
      ...
      console.error('affiliate-onboarding/thanks route errored:', error.digest)
    }
  }, [error])
    ...
    <main className={styles.page} role="alert" aria-live="assertive">
      <div className={styles.card}>
        ...
        <p className={styles.lede}>
          Something went wrong on our side. Your application is safe —
